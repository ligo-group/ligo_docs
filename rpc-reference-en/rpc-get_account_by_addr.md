...
The get_account_by_addr command obtains account information through the account address.

> Request
```
{
  "jsonrpc": "2.0",
  "method": "get_account_by_addr",
  "params": ["CNa5ZMhvFYXSYN4E2sAKqDVBKZgU9AGEBfZ"],
  "id": 1
}
```
